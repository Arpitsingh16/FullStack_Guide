const DAYS = [
  ...
  { day:9,  date:"14 Jun", title:"Chrome Extension",      topics:["JavaScript Challenges","Chrome Extension","DOM","Local Storage"], project:["Chrome Extension"] },
  { day:10, date:"15 Jun", title:"More JS + GitHub",      topics:["More JavaScript","Command Line","GitHub Skills"], tasks:["Practice Git Commands","Practice Terminal Commands"] },
  { day:11, date:"16 Jun", title:"Advanced JavaScript",   topics:["Advanced JavaScript","Scope","Methods","Loops","Function Expressions"], tasks:["Solve Practice Problems"] },
  { day:12, date:"17 Jun", title:"Async JS + APIs",       topics:["Async JavaScript","APIs","Promises","Fetch","Async/Await"], project:["Weather App"] },
  { day:13, date:"18 Jun", title:"Node.js + Express",     topics:["AI Fundamentals","Node.js","Express","Build Node API"], project:["REST API"] },
  { day:14, date:"19 Jun", title:"Full Stack App",        topics:["Full Stack Node App","Database Introduction"], tasks:["Connect App to Database"] },
  { day:15, date:"20 Jun", title:"SQL",                   topics:["SQL","SELECT","INSERT","UPDATE","DELETE","JOIN"], tasks:["SQL Practice"] },
  { day:16, date:"21 Jun", title:"React Basics",          topics:["React Basics","JSX","Components"], project:["First React App"] },
  { day:17, date:"22 Jun", title:"React Props",           topics:["React Props","Dynamic Rendering"], tasks:["Build Components with Props"] },
  { day:18, date:"23 Jun", title:"React State",           topics:["React State","useState","Forms","Events"], project:["Interactive React App"] },
  { day:19, date:"24 Jun", title:"useEffect + Capstone",  topics:["useEffect","API Calls","React Capstone"], project:["Complete Capstone Project"] },
  { day:20, date:"25 Jun", title:"TypeScript + Next.js",  topics:["TypeScript Fundamentals","TypeScript in React","Next.js","Rendering Strategies"], project:["Build Next.js App"] },
];
